...
with DAG(
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='bkt-data-src',  # Replace with your bucket name
        source_objects=['global_health_data.csv'],  # Path to your file in the bucket
        destination_project_dataset_table='vigilant-tract-457207-f8.staging_dataset.health_data',  # Replace with your project, dataset, and table name
        source_format='CSV', 
